            ...
            <Popover>
                <PopoverTrigger asChild>
                    <Button
                        ...
                        variant={"outline"}
                        className={cn(
                            "w-full h-14 text-left font-normal flext justify-between",
                    ...
                    >
                        ...
                        <div>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                ...
                                <path d="M8.5 15.0001C8.37 15.0001 8.24 14.9701 8.12 14.9201C7.99 14.8701 7.89 14.8001 7.79 14.7101C7.61 14.5201 7.5 14.2701 7.5 14.0001C7.5 13.8701 7.53 13.7401 7.58 13.6201C7.63 13.5001 7.7 13.3901 7.79 13.2901C7.89 13.2001 7.99 13.1301 8.12 13.0801C8.48 12.9301 8.93 13.0101 9.21 13.2901C9.39 13.4801 9.5 13.7401 9.5 14.0001C9.5 14.0601 9.49 14.1301 9.48 14.2001C9.47 14.2601 9.45 14.3201 9.42 14.3801C9.4 14.4401 9.37 14.5001 9.33 14.5601C9.3 14.6101 9.25 14.6601 9.21 14.7101C9.02 14.8901 8.76 15.0001 8.5 15.0001Z" fill="#292D32" />
                                ...
                                <path d="M8.5 18.4999C8.37 18.4999 8.24 18.47 8.12 18.42C8 18.37 7.89 18.2999 7.79 18.2099C7.61 18.0199 7.5 17.7599 7.5 17.4999C7.5 17.3699 7.53 17.2399 7.58 17.1199C7.63 16.9899 7.7 16.88 7.79 16.79C8.16 16.42 8.84 16.42 9.21 16.79C9.39 16.98 9.5 17.2399 9.5 17.4999C9.5 17.7599 9.39 18.0199 9.21 18.2099C9.02 18.3899 8.76 18.4999 8.5 18.4999Z" fill="#292D32" />
                                <path d="M12 18.4999C11.74 18.4999 11.48 18.3899 11.29 18.2099C11.11 18.0199 11 17.7599 11 17.4999C11 17.3699 11.03 17.2399 11.08 17.1199C11.13 16.9899 11.2 16.88 11.29 16.79C11.66 16.42 12.34 16.42 12.71 16.79C12.8 16.88 12.87 16.9899 12.92 17.1199C12.97 17.2399 13 17.3699 13 17.4999C13 17.7599 12.89 18.0199 12.71 18.2099C12.52 18.3899 12.26 18.4999 12 18.4999Z" fill="#292D32" />
                                ...
                                <path d="M20.5 10.34H3.5C3.09 10.34 2.75 9.99997 2.75 9.58997C2.75 9.17997 3.09 8.83997 3.5 8.83997H20.5C20.91 8.83997 21.25 9.17997 21.25 9.58997C21.25 9.99997 20.91 10.34 20.5 10.34Z" fill="#292D32" />
