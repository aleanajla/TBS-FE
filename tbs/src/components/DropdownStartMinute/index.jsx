...
export function DropdownStartMinute({ dataStartMinute }) {
  ...
  return (
    <div className="flex flex-col gap-y-3">
      ...
      {/* <Select>
        ...
        <SelectContent
          position="popper"
          className="z-[999] overflow-y-auto max-h-40"
        >
          {generateOptions()}
          {options.map((option, index) => (
            ...
            <SelectItem
              ...
              value={option}
              onSelect={() => {
                console.log("Start Minute", option);
                // dataStartMinute(option);
              }}
            >
              {option}
            </SelectItem>
